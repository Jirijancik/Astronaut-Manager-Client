...
import '../styles/LoadingLayerStyle.scss'
...
const LoadingLayer = (props) => {
    return [
        ...
        <div className="Loading-Wrapper">
            <svg className="Loading-Wrapper__Rocket" width="463" height="374" viewBox="0 0 926 749" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="undraw_to_the_moon_v1mv 1">
                    <g clip-path="url(#clip0)">
                        <path id="RocketFlame" d="M292.14 694.016L277.577 749C254.535 596 262.194 746.112 256.641 740.97C253.341 709.555 242 685.748 242 678.477L247.969 596H278.411H308.853L319 670.109C313.031 674.815 305.733 735.828 300.181 740.97C294.628 746.112 299.992 694.016 292.14 694.016Z" fill="#F26437"/>
                        <g id="Stars">
                ...
                <defs>
                    ...
                    <linearGradient id="paint1_linear" x1="597.5" y1="280" x2="9.49999" y2="287" gradientUnits="userSpaceOnUse">
                        <stop offset="0.545624" stop-color="#FEF7F7" />
                        <stop offset="0.932859" stop-color="#121212" stop-opacity="0.17" />
                    </linearGradient>
                    <linearGradient id="paint2_linear" x1="280" y1="516.815" x2="280" y2="652" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#302A92" />
                        <stop offset="0.333294" stop-color="#7068F8" />
        ...
        <h2 className="Loading-Wrapper__Header"> LOADING... </h2>
        </div>
    ]
}
